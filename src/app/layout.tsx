...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-gradient-to-br from-zinc-50 to-gray-100 dark:from-black dark:to-zinc-900 font-sans transition-colors duration-300">
